      ...
      <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
        ...
        <div className='flex flex-col gap-4 flex-1'>
          ...
          <div className='flex flex-wrap gap-6'>
            ...
            <div className='flex items-center gap-2'>
              <input type='number' id='regularPrice' onChange={handleChange} value={formData.regularPrice} min="50" max="1000000" required className='p-3 border border-gray-300 rounded-lg' />
            ...
            <p className='text-red-700 text-sm'>{imageUploadError && imageUploadError}</p>
            {
              formData.imageUrls.length > 0 && formData.imageUrls.map((url,index)=>(
                <div key={url} className='flex justify-between p-3 border items-center'>
                  ...
                  <button onClick={()=>{handleRemoveImage(index)}} className='p-3 text-red-700 uppercase hover:opacity-75'>Delete</button>
                  <button>Edit</button>
                </div>
              ))
            }
